...
async fn test_pushdown_common_cfg(
    ...
    // TODO: Control genesis timestamp in anvil to achieve deterministic blocks
    let df = df
        .with_column("block_hash", lit("-"))
        .unwrap()
        .with_column("block_timestamp", lit("-"))
        .unwrap();
...
async fn test_project() {
    ...
    super::utils::assert_data_eq(
        ...
        indoc!(
            ...
            +------------------------------------------------------------------+--------------+-------------------+
            | dd1d9281dbbc24fe024609d04aea7751d798eea748d53e1d2c8c2474d29d8345 | 3            | 0                 |
            | dd1d9281dbbc24fe024609d04aea7751d798eea748d53e1d2c8c2474d29d8345 | 3            | 0                 |
            | 3d392d33c29dfdba170c17aff7dd671c63e9cfed7832957ba3b6898e004d1143 | 4            | 0                 |
            | 3d392d33c29dfdba170c17aff7dd671c63e9cfed7832957ba3b6898e004d1143 | 4            | 0                 |
            +------------------------------------------------------------------+--------------+-------------------+
            "#
        ),
